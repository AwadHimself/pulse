...
const formData = ref({
  ...
  const {serverErorr , handleServerError , realTimeErrors ,handleLoginForm} = useFormErrors()
  useFormErrors()
        ...
        <form class="grid gap-4" @submit.prevent="signin">
          <div class="grid gap-2">
            ...
            <Input
              ...
              :class="{ 'border-red-500': serverErorr }"
            />
            <ul
          ...
          <ul class="text-sm text-left text-red-500" v-if="serverErorr">
            <li class="list-disc">{{ serverErorr }}</li>
          </ul>
